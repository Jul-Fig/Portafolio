...
const Cards = ({ title, description, img, link, tags = [] }) => {
  ...
  return (
    <motion.div
      ...
      /* w-full en mobile, ancho fijo en sm+ */
      className="relative w-full sm:w-80 h-96 rounded-xl border-double border-4 border-[#685281] bg-gradient-to-br from-[#b3a4d5] bg-transparent"
    >
      <div
